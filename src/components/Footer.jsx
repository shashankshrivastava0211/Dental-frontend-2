...
import { ADDRESS, CLINIC_NAME, EMAIL, PHONE } from "../constants/constant";
	...
	return (
		<>
			<Helmet>
				<meta
					name="description"
					content={`${CLINIC_NAME} offers comprehensive dental care services including general dentistry, cosmetic dentistry, orthodontics, and pediatric dentistry. Contact us at ${PHONE} or ${EMAIL} to schedule an appointment.`}
				/>
				<meta
					name="keywords"
					...
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-10">
						...
						<div className="lg:col-span-4 text-center lg:text-left">
							...
							<p className="text-indigo-200 text-sm leading-relaxed mb-8 mx-auto lg:mx-0 max-w-sm">
								At <strong>{CLINIC_NAME}</strong>, we provide gentle, expert
								dental care in a welcoming environment. Our team uses modern
								technology to keep your smile healthy, bright, and confident.
							</p>
						</div>
