          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-10">
            ...
            <div className="lg:col-span-4 text-center lg:text-left">
              <div className="flex items-center justify-center lg:justify-start mb-6">
                <div className="mr-2 flex items-center justify-center rounded-xl bg-gradient-to-br from-cyan-500 p-1.5 sm:p-2 shadow-md">
                  <Stethoscope
              ...
              <p className="text-indigo-200 text-sm leading-relaxed mb-8 mx-auto lg:mx-0 max-w-sm">
                At {CLINIC_NAME} , we're committed to providing exceptional
                dental care in a comfortable environment. Our team of
                experienced professionals uses the latest technology to ensure
