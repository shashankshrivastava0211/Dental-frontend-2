...
const Hero1 = ({
  ...
  return (
    <div className="relative bg-gradient-to-b from-cyan-50 to-white overflow-hidden">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
        <div className="flex flex-col lg:flex-row items-center">
          ...
          >
            {/* Badge */}
            {BadgeIcon && (
              <div className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-cyan-100 text-cyan-800 mb-6">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight mb-6">
              {heading}{" "}
              <span className="text-teal-600">{headingHighlight}</span>{" "}
              {headingEnd}
            </h1>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              {secondaryButtonText && (
                ...
                >
                  {SecondaryButtonIcon && (
                    <SecondaryButtonIcon className="w-5 h-5 mr-2" />
                  )}
                  {secondaryButtonText}
                </button>
              )}
            ...
            {scrollToRef && (
              <div
                className="hidden md:flex items-center mt-12 cursor-pointer"
                onClick={() => {
          ...
          <div className="w-full lg:w-1/2 relative" data-aos="fade-left">
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-2xl">
              ...
              {FloatingBadgeIcon && (
                <div
                  className="absolute bottom-4 left-4 bg-white rounded-lg shadow-lg p-3 flex items-start"
                  data-aos="fade-up"
                  data-aos-delay="300"
                >
