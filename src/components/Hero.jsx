					...
					<div className="max-w-xl">
						...
						<div
							...
							{primaryButtonText && (
								<a
									href="#"
									className="px-6 sm:px-8 py-3 sm:py-4 bg-white text-cyan-600 font-semibold rounded-full shadow-lg hover:shadow-xl transition-all text-base sm:text-lg relative overflow-hidden"
									...
									<span
										...
										className="absolute inset-0 opacity-0 hover:opacity-100 hover:w-[300%] hover:h-[300%]"></span>
								</a>
							)}
							...
							<div className="relative">
								...
								{FloatingBadgeIcon && floatingBadgeTitle && (
									<div
										...
										data-aos="fade-up"
										data-aos-delay="600">
										<div className="bg-cyan-100 p-1 sm:p-2 md:p-3 rounded-lg">
											<FloatingBadgeIcon className="w-4 h-4 sm:w-5 sm:h-5 md:w-7 md:h-7 text-cyan-600 fill-cyan-600 stroke-sky-800" />
										</div>
										<div>
											<div className="text-xs sm:text-sm md:text-base font-semibold text-cyan-900">
												{floatingBadgeTitle}
											</div>
											{floatingBadgeText && (
				...
				{scrollText && scrollToRef && (
					<div className="absolute -bottom-40  -sm:bottom-44 left-0 right-0 text-center">
						<button
							...
							className="group inline-flex flex-col items-center gap-2 sm:gap-3 text-base sm:text-lg md:text-xl font-medium text-white hover:text-cyan-200 transition-colors"
							data-aos="fade-up"
							data-aos-delay="500">
