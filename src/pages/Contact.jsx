		...
		<div className="min-h-screen overflow-hidden">
			...
			<section
				...
				<div className="absolute top-0 left-0 w-full h-full overflow-hidden">
					...
					<div className="absolute -bottom-40 -left-40 w-96 h-96 bg-cyan-200 rounded-full opacity-50"></div>
				</div>
					...
					<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
						{contactMethods.map((method, index) => (
							<div
								...
								{/* Decorative elements */}
								<div className="absolute -bottom-10 -right-10 w-24 h-24 bg-cyan-100 rounded-full opacity-0 group-hover:opacity-20 transition-opacity duration-500"></div>
								<div className="absolute -top-10 -left-10 w-24 h-24 bg-cyan-100 rounded-full opacity-0 group-hover:opacity-20 transition-opacity duration-500"></div>
							</div>
						))}
					</div>
				</div>
						...
						<div className="lg:w-1/2" data-aos="fade-right">
							<div className="relative">
								...
								<div className="relative">
									...
									{/* Decorative elements */}
									<div
										className="absolute -top-8 -left-8 w-32 h-32 border-8 border-cyan-50  bg-cyan-100 -z-10"
										style={{
