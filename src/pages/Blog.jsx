						...
						<form
							...
							<div className="space-y-4">
								...
								<button
									...
									className={`w-full rounded-xl px-6 py-3 bg-gradient-to-r from-cyan-600 via-teal-600 to-sky-600 text-white font-semibold text-lg shadow-lg hover:shadow-xl transform transition-all duration-300 ease-in-out ${
										isSubscribing
											? "opacity-75 cursor-not-allowed"
											: "hover:from-cyan-700 hover:via-teal-700 hover:to-sky-700"
									}`}>
