		...
		<>
			...
			<div className="min-h-screen bg-gradient-to-br from-cyan-50 via-teal-50 to-sky-50">
				...
				<div className="py-12 md:py-16 lg:py-20 relative overflow-hidden flex items-center">
					{/* Background Elements */}
					<div className="absolute inset-0 bg-gradient-to-b from-cyan-50 via-teal-50 to-sky-50 opacity-70"></div>
					...
					<div
						...
						<div className="text-center mb-12 md:mb-16">
							<h2
								className="text-3xl md:text-4xl lg:text-5xl font-bold text-cyan-900 mb-6 leading-tight"
								data-aos="fade-up"
								data-aos-delay="200">
								Your Dental{" "}
						...
						<div className="lg:hidden mb-6">
							<button
								...
								className="w-full flex items-center justify-center gap-2 px-6 py-3 bg-white rounded-xl border border-indigo-100 shadow-sm text-cyan-600 font-medium hover:bg-indigo-50 transition-colors">
						...
						<div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
							...
							<div className="lg:col-span-9">
								<div className="bg-white rounded-3xl shadow-xl p-6 md:p-8 mb-8">
									<form
										...
										<button
											type="submit"
											disabled={loading}
											className="px-6 py-3 bg-gradient-to-r from-cyan-600 vaia-teal-600 to-sky-600 text-white rounded-xl hover:from-indigo-700 hover:to-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-all duration-200 flex items-center justify-center gap-2 disabled:opacity-50 shadow-lg shadow-indigo-500/25">
											{loading ? (
								...
								{loading ? (
									...
									<div className="text-center py-12 bg-white rounded-3xl shadow-xl">
										<div className="w-16 h-16 bg-gradient-to-b from-teal-500 to-cyan-600  rounded-2xl flex items-center justify-center mx-auto mb-4">
											...
											<table className="min-w-full divide-y divide-gray-200">
												<thead className="bg-gradient-to-r from-indigo-50 to-purple-50">
													<tr>
														<th
															scope="col"
															className="px-3 py-4 text-left text-xs font-semibold text-cyan-800 uppercase tracking-wider">
															S.No
														</th>
														<th
															scope="col"
															className="px-6 py-4 text-left text-xs font-semibold text-cyan-800 uppercase tracking-wider">
															Patient
														</th>
														<th
															scope="col"
												...
												<tbody className="bg-white divide-y divide-gray-200">
													{appointments.map((appointment, index) => (
														<tr
															...
															<td className="px-6 py-4 whitespace-nowrap">
																<div className="text-sm text-gray-900 flex items-center">
																	<Stethoscope className="h-4 w-4 mr-1 text-cyan-600" />
															...
															<td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
																<button className="text-cyan-600 hover:text-cyan-900 font-medium">
																	View
																	<br /> Details
																</button>
															</td>
										...
										{totalPages > 1 && (
											<div className="flex items-center justify-between px-6 py-4 bg-gradient-to-r from-indigo-50 to-purple-50">
												<button
													...
													disabled={page === 1}
													className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-cyan-600 disabled:text-gray-400">
