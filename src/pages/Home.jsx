		...
		<div className="min-h-screen overflow-hidden">
				...
				<div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32">
					<div className="max-w-4xl mx-auto text-center">
						...
						<div
							...
							data-aos-delay="400">
							<button
								className="px-8 py-4 bg-gradient-to-r from-teal-600 via-cyan-600 to-sky-600 text-white rounded-full font-semibold hover:shadow-lg transform hover:-translate-y-1 transition-all duration-300"
								onClick={() => {
			...
			<div className="relative -mt-16 z-20 mx-4 lg:mx-8">
				<div className="container mx-auto">
					<div className="grid grid-cols-4 gap-4 md:gap-6 bg-gradient-to-r from-cyan-700 via-sky-600 to-cyan-500 rounded-xl lg:rounded-2xl shadow-lg lg:shadow-xl p-6 md:p-8 animate-fadeInUp font-publicSans text-white">
						{stats.map((stat, index) => (
							<div
								...
								<div className="bg-cyan-50 p-1 md:p-2 w-8 h-8 md:w-12 md:h-12 lg:w-16 lg:h-16 rounded-full flex items-center justify-center mx-auto mb-2 md:mb-4">
									{stat.icon}
								</div>
					...
					<div className="flex flex-col-reverse lg:flex-row items-stretch gap-12 lg:gap-16">
									...
									<div className="relative w-[90%] h-[90%] bg-white rounded-[2rem] p-2 shadow-2xl">
										...
										<div
											...
											<div className="flex items-center gap-4">
												<div className="bg-gradient-to-br from-cyan-600 via-teal-600 to-sky-600 p-3 rounded-xl shadow-lg">
													<Star className="w-4 h-4 lg:w-6 lg:h-6 text-white drop-shadow-sm" />
												</div>
												<div>
													<p className="text-lg font-bold bg-gradient-to-r from-cyan-600 via-teal-600 to-sky-600 bg-clip-text text-transparent">
														4.9/5
													</p>
						...
						<div
							...
							<div
								...
								<span className="bg-gradient-to-r from-cyan-600 via-sky-600 to-cyan-600 bg-clip-text text-transparent font-semibold">
									Patient Care
								</span>
							</div>
							...
							<h2
								...
								data-aos-delay="300">
								Your Smile Deserves{" "}
								<span className="bg-gradient-to-r from-cyan-800 via-teal-600 to-sky-500 bg-clip-text text-transparent">
									The Best Care
								</span>
							</h2>
							...
							<div
								...
								{[
									...
									<div
										...
										<div className="bg-gradient-to-br from-cyan-600 to-sky-400 p-2 rounded-xl shadow-sm transform transition-transform duration-300 group-hover:scale-110">
