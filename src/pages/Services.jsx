								...
								<div className="grid sm:grid-cols-2 gap-6">
									{specialties.map((specialty, index) => (
										<div
											...
											<div className="bg-gradient-to-br from-cyan-50 via-teal-50 to-sky-50 p-2 rounded-xl group-hover:scale-110 transition-transform duration-300">
												{specialty.icon}
											</div>
											<div>
				...
				<div className="container mx-auto px-4 sm:px-6 lg:px-8">
					...
					<div className="text-center mb-16">
						<div className="inline-flex items-center justify-center mb-4">
							...
							<span className="mx-4 text-sm text-cyan-600 font-semibold">
								OUR SERVICES
							</span>
							<div className="h-[1px] w-10 bg-cyan-500"></div>
						</div>
						...
						<h2 className="text-3xl md:text-4xl font-bold text-cyan-900 mb-4">
							Exceptional Dental <span className="text-cyan-600">Services</span>
						</h2>
									...
									<div className="space-y-2 mb-6">
										{service.features.slice(0, 2).map((feature, idx) => (
											<div key={idx} className="flex items-start">
												<CheckCircle className="w-5 h-5 text-cyan-500 mr-2 flex-shrink-0" />
					...
					<div className="mt-4 sm:mt-6 md:mt-0">
						<div className="flex gap-10">
							<a
								...
								className="inline-block rounded-xl px-5 sm:px-7 py-2 sm:py-3 bg-gradient-to-r from-cyan-600 to-sky-700 text-white hover:from-cyan-700 hover:to-sky-800 font-semibold text-base sm:text-lg shadow-lghover:shadow-xl transform transition-all duration-300 ease-in-out border border-white/10">
								Book Appointment
							</a>
							<a
								href="/contact"
